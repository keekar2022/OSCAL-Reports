...
### Port Configuration (Version 2.0)
...
│   ├── mistralService.js   # Mistral 7B integration
...
│   │   └── users.json      # User accounts (PBKDF2 passwords)
...
│   │   │   └── passwordGenerator.js  # Frontend password utilities
...
├── docker-compose.yml      # Docker Compose (includes Ollama)
├── ARCHITECTURE.md         # This file
├── README.md               # Main documentation
└── TRUENAS_DEPLOYMENT.md   # TrueNAS deployment guide
```
